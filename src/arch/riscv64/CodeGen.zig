...
fn binOpRegister(
    ...
    _ = try switch (mir_tag) {
        ...
        .div => self.addInst(.{ .div = mir_data }),
        .divw => self.addInst(.{ .divw = mir_data }),
        .divu => self.addInst(.{ .divu = mir_data }),
        .divuw => self.addInst(.{ .divuw = mir_data }),
        .mul => self.addInst(.{ .mul = mir_data }),
        .mulw => self.addInst(.{ .mulw = mir_data }),
        .mulh => self.addInst(.{ .mulh = mir_data }),
        .mulhsu => self.addInst(.{ .mulhsu = mir_data }),
        .mulhu => self.addInst(.{ .mulhu = mir_data }),
        .rem => self.addInst(.{ .rem = mir_data }),
